  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#f6cdd0]">
      ...
      <div className="flex-grow pt-20 pb-20 mt-24 flex flex-col items-center justify-center w-full">
        ...
        <h1 className="text-5xl font-bold mb-16 text-center text-[#704218] [text-shadow:0px_4px_4px_#00000040]">Gender Identitiies</h1>
            {/*Page content */}
          ...
          <div className="flex flex-col items-center space-y-2 mt-4">
            ...
            <div className="flex space-x-2">
              <span>1</span>
              <span>2</span>
              <span className="font-bold">2.5</span> {/* Highlight the current page */}
              <span>3</span>
              <span>4</span>
            </div>
          </div>
