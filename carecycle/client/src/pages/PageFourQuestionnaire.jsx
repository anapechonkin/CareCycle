...
const PageFourQuestionnaire = () => {
  ...
  const [preferNotToAnswerRules, setPreferNotToAnswerRules] = useState(false);
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#f6cdd0]">
      ...
      <div className="flex-grow pt-20 pb-20 mt-24 flex flex-col items-center justify-center w-full">
        ...
        <div className={`overflow-auto h-80 border-2 border-black rounded-lg p-6 mb-6 bg-white text-xl ${preferNotToAnswerRules ? 'opacity-50' : ''}`}> {/* Increased height, border, padding, and text size */}
            ...
            <div className="flex justify-between mt-6 text-2xl"> {/* Increased text size */}
              <label className="flex items-center">
                <input
                  ...
                  disabled={preferNotToAnswerRules}
                />
          ...
          <div className="flex justify-center mt-4">
            <label className="flex items-center text-lg cursor-pointer">
              <input
                ...
                checked={preferNotToAnswerRules}
                onChange={() => setPreferNotToAnswerRules(!preferNotToAnswerRules)}
              />
          ...
          <div className="flex justify-between w-full mt-8">
            ...
            <Button 
              ...
              disabled={preferNotToAnswerRules || rulesAccepted === null}
            />
          </div>
